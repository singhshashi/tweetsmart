...
FlutterAPI.prototype.post = function(url, token, secret, body, contentType, cb) {
  var self = this;
  
  url = 'https://api.twitter.com/1.1/' + url;
  self.oauth.post(url, token, secret, body, contentType, function(err,data,res){
    if (err){
     self.debug('error posting data');
